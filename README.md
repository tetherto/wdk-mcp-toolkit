...
const transfers = await server.indexerClient.getTokenTransfers(
  "ethereum",
  "usdt",
  address,
);
const balance = await server.indexerClient.getTokenBalance(
  "ethereum",
  "usdt",
  address,
);
...
server.registerTools([...WALLET_TOOLS, myCustomTool, anotherCustomTool]);
```
